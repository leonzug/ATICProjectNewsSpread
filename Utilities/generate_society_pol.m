function [A,people,FakeSources, RealSources,x0,nodenames] = generate_society_pol (nPeople,traits, distr, nRealNews, nFakeNews, newsRange, locality, C, nRoot)
...
[A, FakeSources, RealSources] = generate_adiacency_pol(people, traits, nRealNews, nFakeNews, newsRange, locality, C, nRoot);
